                        ...
                        <div class="row">
                            <div class="col-md-6 col-sm-12">
                                <div class="form-group m-t-20">
                                    ...
                                    <input type="text" name="first_name" class="form-control" placeholder="Enter First Name" value="{{$user->name}}" required>
                                </div>
                            </div>
                            <div class="col-md-6 col-sm-12">
                                <div class="form-group m-t-20">
                            ...
                            <div class="col-md-6 col-sm-12">
                                ...
                                <label>Role</label>
                                        <select class="select2 form-control custom-select" name="role" style="width: 100%; height:36px;" required>
                                            ...
                                            <option {{$user->roles->first()->id==$role->id?'checked':''}}  value="{{$role->id}}">{{$role->name}}</option>
                                            @endforeach
                                        </select>
                                </div>
                            </div>
