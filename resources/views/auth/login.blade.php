            ...
            <div class="auth-box bg-dark border-top border-secondary">
                <div id="loginform">
                    <div class="text-center p-t-20 p-b-20">
                        <span class="logo-text"><img style="width: 40%;" class="img--dashboard onerror-image" data-onerror-image="{{ asset('assets/images/admin/upload-img.png') }}" src="{{ \App\Helpers\Helper::onerror_image_helper($logoHeader, asset('storage/assets/images/admin/'.$logoHeader), asset('assets/images/admin/upload-img.png'), 'assets/images/admin/') }}" alt="logo" /></span>
                    </div>
                    <!-- Form -->
