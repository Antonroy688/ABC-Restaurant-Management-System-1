...
.maincontainer {
  ...
  top: -50px;
  transform: scale(0.8);
  background: url("{{asset('assets/images/admin/HauntedHouseBackground.png')}}");
...
<div class="maincontainer">
  ...
  <img class="foregroundimg" src="{{asset('assets/images/admin/HauntedHouseForeground.png')}}" alt="haunted house">
